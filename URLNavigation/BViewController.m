...
- (void)loadMessageID:(NSNumber *)messageID
{
    Sample *sampe = [Sample syncFetchBy:messageID];
    NSLog(@"sample content :: %@",sampe.messageContent);
}
...
- (void)jump
{
    [YQNavigator showViewControllerToURL:CVC_URL from:self];
}
